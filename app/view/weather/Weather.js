...
Ext.define('YzMobile.view.weather.Weather', {
    ...
    config: {
        ...
        tpl: Ext.create('Ext.XTemplate',
            '<div style="position:absolute;height:55%;width:100%;color:white;padding:0px 10px 0px 0px;margin:0 0 0 0;">',
            '<div style="height:40%;width:100%;">',
            '<div style="height:100%;width:40%;float:left;font-size:14px;text-align:centre;">{time}发布</div>',
            '<div style="height:100%;width:40%;float:right;font-size:48px;text-align:centre;vertical-align : middle">{tempreal}</div>',
            '</div>',
            '<div style="height:60%;width:100%;font-size:14px;clear:both;">',
            '<div style="height:24%;font-size:18px;width:100%;">{weather}</div>',
            '<div style="height:24%;width:100%;">空气质量：{air}</div>',
            '<div style="height:24%;width:100%;">湿度：{humidity}  {windreal}</div>',
            '<div style="height:24%;width:100%;">{date}</div>',
            '</div>',
            '</div>',
            '<div style="position:absolute;height:45%;width:96%;color:white;font-size:14px;text-align:center;border-top:1px solid #cccccc;border-top-style:dashed;margin:55% 0 0 0 ;padding:0px 10px 0px 0px;">',
